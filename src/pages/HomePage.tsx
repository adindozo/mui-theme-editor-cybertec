    ...
    <ThemeProvider theme={lightTheme}>
      ...
      <Box sx={{ padding: 2 }}>
        ...
        <Typography variant="body1" gutterBottom>
          ...
          Suspendisse potenti. Ut sollicitudin pharetra sem. Phasellus at felis
          gravida, cursus sem ac, congue felis. Etiam auctor, libero in tempor
          vulputate, nunc tortor sollicitudin nisi, nec ullamcorper felis lorem
          id nisi. Integer efficitur urna et nisl mollis, at scelerisque orci
          convallis. Cras interdum, orci nec dignissim placerat, sapien ante
          dictum purus, et volutpat metus arcu a augue. Integer sollicitudin ex
          non risus luctus, vitae cursus enim varius.
        </Typography>
      </Box>
