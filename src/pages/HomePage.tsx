...
export default function HomePage() {
  ...
  return (
    ...
    >
      <CssBaseline />
      <div className="verylonganduniqueclassname">
        {/* HEADER */}
        <Header />
        <Container>
          {/* HERO SECTION */}
          ...
          <Box sx={{ padding: 2 }}>
            ...
            <Typography variant="h5" gutterBottom>
              ...
              Curabitur venenatis felis at nunc malesuada, a tincidunt lectus
              tincidunt. Nam ornare, ligula non faucibus lobortis, sapien arcu
              interdum felis, ac fermentum purus magna et nunc. Integer vel
              libero in elit
            </Typography>
            ...
            <Typography variant="body1" gutterBottom>
              ...
              felis gravida, cursus sem ac, congue felis. Etiam auctor, libero
              in tempor vulputate, nunc tortor sollicitudin nisi, nec
              ullamcorper felis lorem id nisi. Integer efficitur urna et nisl
              mollis, at scelerisque orci convallis. Cras interdum, orci nec
              dignissim placerat, sapien ante dictum purus, et volutpat metus
              arcu a augue. Integer sollicitudin ex non risus luctus, vitae
              cursus enim varius.
            </Typography>
